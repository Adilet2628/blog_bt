...
class PostViewSet(ModelViewSet):
    ...
    #api/v1/posts/ PATCH - update
    # api/v1/posts/ GET -detail
    #api/v1/posts/id/ DELETE -  destroy
    #api/v1/posts/id/comments/ GET -  destroy
    ...
    def comments(self, request, pk):
        ...
        serializer = ComentSerializer(instance=comments,many=True)
    ...
    def favorites(self, request, pk):
        ...
        if favorite.exists():
            favorite.delete()
            return Response({'msg': 'Delete from  Favorites!'}, status=204)
